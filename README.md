...
<svg xmlns="http://www.w3.org/2000/svg"
  ...
  <title>Einfeche SVG Grafiken</title>
  <desc>Diese SVG-Datei enthält eine Line, ein Kreisd und ein Rechtck.</desc>

  <!-- A straight line -->
  <line x1="-100" y1="-100" x2="100" y2="-100" stroke="yellow" stroke-width="2" />

  <!-- A circle -->
  <circle cx="0" cy="0" r="50" fill="red" />

  <!-- A rectangle -->
  <rect x="150" y="-25" width="100" height="50" fill="blue" />
...
Durch das Benutzen von Rauten (#) vor dem eigentlichen Text, werden in Markdown Überschriften erzeugt. Je mehr Rauten, desto kleiner die Überschrift – von 1x # (ganz groß) bis 6x # (kleinste Vartiante).
<details>
...
Um kursiver Text zu erhalten wird einfach der benötigte Text mit einem Sternchen *kursiv* oder einem Unterstrich _kursiv_ markiert, fettgedruckter Text mit zwei Sternchen **fett** oder zwei Unterstrichen __fett__ ausgegeben.
<details>
...
Um Auflistungen zu erhalten werden bzw können die folgenden Zeichen verwendet werden: - , * oder + 
Für Aufzählungen werden Zahlen mit Punkten verwendet, wie 1. , 2. usw. Tabellen bestehen aus Spalten, die mit dem Zeichen | (pipe; Alt Gr + <) voneinander getrennt sind, und einer Kopfzeile, die mit dem Minuszeichen --- unterstrichen wird.
...
<details>
    ...
    Die Folgenden Datein sind nach der Eingabe des Befehls ls vorzufinden: 
     example.pdf.aux  
     example.pdf.log  
     example.pdf.pdf  
     main.tex
...
Um den Namen der Pdf-Datei zu ändern, wird der befehl  -jobname mit dem neuen Dateinamen verwendet. Als Bsp.
     ![Screenshot 2025-05-01 161322](https://github.com/user-attachments/assets/0fffbad3-1b68-459b-885b-b4379041af57)
...
What changes in your pdf, if you change the documentclass to book

Beim Ändern des Parameters \documentclass von "article" zu "book" fügt das Textsatzsystem LaTex (als Client-rendered Markup-Language) eine neue Seite nach dem Titel ein, ebenso verändern sich Teile der Formatierung; nach der Änderung sind die Seitenränder größer.


What changes in your pdf, if you add \section{Intro} after \maketitle

Wird nach dem Ausdruck \maketitle eine neue Zeile mit \section{Intro} hinzugefügt. So führt der neue Ausdruck zum Erstellen einer Abschnittsüberschrift mit dem Titel "Intro". Diese Überschrift wird in der Pdf-Datei unter dem Titelblatt angezeigt. Damit wird ein neuer Abschnitt im Dokument mit dem Titel "Intro" eingeleitet.
...
Der Text Hello World wird nun deutlich größer und in Fetter-Schrift dagestellt
...
Es wird unter dem Hello World eine einfache Auflistung in Form von Bulletpoints erstellt. Dazu wird der Befehl  <li> " Text des Aufzählungspunktes " </li> verwendet
